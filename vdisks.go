...
// CreateVDisk ...
func CreateVDisk(n *NTNXConnection, d *VDiskJSONREST) (TaskUUID, error) {
...
// CloneVDiskforVM ...
func CloneVDiskforVM(n *NTNXConnection, v *VMJSONAHV, VMDiskUUID string, ContainerID string) (TaskUUID, error) {
