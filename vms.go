...
// GetVMbyName ...
func GetVMbyName(n *NTNXConnection, v *VMJSONAHV) (VMJSONAHV, error) {
	...
	json.Unmarshal(resp, &vmAHV)

	return vmAHV, err
}

// GetVMIDbyTask ...
func GetVMIDbyTask(n *NTNXConnection, t *TaskJSONREST) string {
...
// CreateVM ...
func CreateVM(n *NTNXConnection, v *VMJSONAHV) (TaskUUID, error) {
...
// CreateVMAHV ...
func CreateVMAHV(n *NTNXConnection, v *VMJSONAHV) (TaskUUID, error) {
...
// GetVMsbyContainer returns an array of VmIds of VMs reside on a given container
// nil if nothing could found
func GetVMsbyContainer(n *NTNXConnection, containerName string) ([]string, error) {

	var VMListing []string

	containerID, err := GetContainerIDbyName(n, containerName)
	if err != nil {
		return nil, err
	}
...
// GetVMState ...
func GetVMState(n *NTNXConnection, vm *VMJSONAHV) string {
...
// GetVMIP ...
func GetVMIP(n *NTNXConnection, vm *VMJSONAHV) (string, error) {

	resp, _ := NutanixAPIGet(n, NutanixRestURL(n), "vms/"+vm.UUID)

	var vmREST VMJSONREST

	if err := json.Unmarshal(resp, &vmREST); err != nil {
		panic(err)
	}

	if len(vmREST.IPAddresses) > 0 {
		return vmREST.IPAddresses[0], nil
	}
...
// CreateVDiskforVM ...
func CreateVDiskforVM(n *NTNXConnection, v *VMJSONAHV, d *VDiskJSONREST) (TaskUUID, error) {
...
// CreateVNicforVM ...
func CreateVNicforVM(n *NTNXConnection, v *VMJSONAHV, net *NetworkREST) (TaskUUID, error) {
...
// CreateVNicforVMwithMAC ...
func CreateVNicforVMwithMAC(n *NTNXConnection, v *VMJSONAHV, net *NetworkREST, macAddress string) (TaskUUID, error) {
...
// DelteVNicforVM ...
func DelteVNicforVM(n *NTNXConnection, v *VMJSONAHV, macAddress string) (TaskUUID, error) {
...
// StartVM ...
func StartVM(n *NTNXConnection, v *VMJSONAHV) (TaskUUID, error) {
...
// StopVM ...
func StopVM(n *NTNXConnection, v *VMJSONAHV) (TaskUUID, error) {
...
// DeleteVM ...
func DeleteVM(n *NTNXConnection, v *VMJSONAHV) (TaskUUID, error) {
