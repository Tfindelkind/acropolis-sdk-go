...
type ContainerJSONREST struct {
	Entities []struct {
		...
		UsageStats                    struct {
			...
			DataReductionDedupUserPostReductionBytes         string `json:"data_reduction.dedup.user_post_reduction_bytes"`
			DataReductionDedupUserPreReductionBytes          string `json:"data_reduction.dedup.user_pre_reduction_bytes"`
			...
			StorageUnreservedSharedUsageBytes                string `json:"storage.unreserved_shared_usage_bytes"`
...
// ContainerListJSONREST ...
type ContainerListJSONREST struct {
	Metadata struct {
		GrandTotalEntities int    `json:"grandTotalEntities"`
		TotalEntities      int    `json:"totalEntities"`
		FilterCriteria     string `json:"filterCriteria"`
